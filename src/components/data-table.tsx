                    ...
                    <Table>
                        <TableHeader className="bg-[#f2f5f7] border-b border-[#e0e0e0]">
                            <TableRow className="hover:bg-[#f2f5f7]">
                                <TableHead className="min-w-[200px] w-[30%] font-semibold text-xs uppercase tracking-wider text-[#666666] h-12">Hito a Cumplir</TableHead>
                                <TableHead className="font-semibold text-xs uppercase tracking-wider text-[#666666] h-12">SIAPER</TableHead>
                                <TableHead className="min-w-[150px] font-semibold text-xs uppercase tracking-wider text-[#666666] h-12">Normativa / Naturaleza</TableHead>
                                ...
                                filteredData.map((row) => {
                                    ...
                                    if (isFootnoteRow) {
                                        return (
                                            ...
                                            >
                                                <TableCell colSpan={6} className="text-[12px] sm:text-[13px] text-[#666666] py-3 sm:py-4 italic bg-[#fcfcfc]">
                                                    {row.hito}
                                                </TableCell>
                                            </TableRow>
                                        )
                                    ...
                                    return (
                                        ...
                                        >
                                            <TableCell className="font-semibold text-[14px] sm:text-[16px] text-[#333333] py-4 sm:py-5">
                                                {row.hito}
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell className="text-[13px] sm:text-[14px] text-[#666666]">
                                                {row.normativa}
                                            </TableCell>
                                            <TableCell className="text-[13px] sm:text-[14px] text-[#666666] hidden md:table-cell">{row.periodicidad}</TableCell>
                                            <TableCell className="text-[13px] sm:text-[14px] text-[#666666] hidden md:table-cell">{row.responsable}</TableCell>
                                            <TableCell>
                                                <div className="flex flex-col gap-1.5 lg:flex-row">
                                                    ...
                                                    {!isCritical && !isPeremptory && (
                                                        <span className="text-[12px] sm:text-[13px] text-[#999999] italic">Normal</span>
                                                    )}
                                                </div>
                                            </TableCell>
                                        </TableRow>
